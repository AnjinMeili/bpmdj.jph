...
public:
    ...
    void setupUi(QDialog *BpmDjPreferences)
    {
        ...
        resamplingScan->setChecked(false);
        ...
        experimentalAlg->setChecked(true);
...
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-weight:600;\">Analyzer commands</span></p></body></html>", 0, QApplication::UnicodeUTF8));
        ...
        resamplingScan->setText(QApplication::translate("BpmDjPreferences", "Autodifferencing", 0, QApplication::UnicodeUTF8));
        enveloppeSpectrum->setText(QApplication::translate("BpmDjPreferences", "Enveloppe Spectrum", 0, QApplication::UnicodeUTF8));
        experimentalAlg->setText(QApplication::translate("BpmDjPreferences", "Bpm 2010", 0, QApplication::UnicodeUTF8));
        fullAutoCorrelation->setText(QApplication::translate("BpmDjPreferences", "Amplitude Autocorrelation", 0, QApplication::UnicodeUTF8));
        weightedEnvCor->setText(QApplication::translate("BpmDjPreferences", "Autocorrelation * Energy Envelope", 0, QApplication::UnicodeUTF8));
